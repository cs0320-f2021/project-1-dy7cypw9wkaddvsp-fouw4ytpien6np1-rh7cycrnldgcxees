package edu.brown.cs.student.kdtree.coordinates;



import edu.brown.cs.student.kdtree.node.Node;
import edu.brown.cs.student.kdtree.utils.Utils;
...
public class KdTree<T> {
  ...
  private Node<Coordinate<T>> root = null;
   ...
   */
  // how are we getting this list of coordinates??
  public KdTree(int dimensions, List<Coordinate<T>> coordinates) {
    this.dimensions = dimensions;
    this.root = createKdTree(new ArrayList<>(coordinates)); // why?
  }
  public KdTree(int dimensions){
    this.dimensions = dimensions;
  }
  public void setCoordinates(List<Coordinate<T>> coordinates){
