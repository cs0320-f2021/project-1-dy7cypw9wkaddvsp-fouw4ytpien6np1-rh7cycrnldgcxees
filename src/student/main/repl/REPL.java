...
public class REPL{
     ...
     */
    // pass in HandlerArgs because it's specific to Main
    public REPL(String[] args, Reader in, OptionParser oP, CommandHashmap cH){
    ...
    public void addCommand(String option){
        optionParser.accepts(option);
    }

    public REPL(OptionParser optionParser){
