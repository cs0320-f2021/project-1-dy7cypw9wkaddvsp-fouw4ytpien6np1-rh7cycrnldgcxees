...
public class DatabaseTest {
  ...
  public void testChangePath() {
    ...
    public void testInsert() throws SQLException, ClassNotFoundException, IllegalAccessException {
      ...
      user1.testUsers("55493", "145lbs", "32a", "5", "24", "slim", "Capricorn");
      database.insert(user1); // check to see if this doesn't fail
      Collection<Object> output1 = database.where("body_type", "slim", "users");
    ...
    @Test
    public void testUpdate () throws SQLException, ClassNotFoundException, IllegalAccessException,
